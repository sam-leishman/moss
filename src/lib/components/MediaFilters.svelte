		...
		<div class="flex flex-wrap items-center gap-2">
			<div class="relative">
				...
				{#if showTagDropdown}
					...
					></div>
					<div class="absolute left-0 mt-1 w-64 bg-white rounded-lg shadow-lg border border-gray-200 z-20 max-h-80 overflow-y-auto">
						{#if tagsLoading}
							<div class="p-4 text-center text-sm text-gray-500">Loading tags...</div>
